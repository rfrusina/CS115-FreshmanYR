...
class Test(unittest.TestCase):
    ...
    def test07(self):
        sequence = '1100' * 16
        compress = hw6.compress(sequence)
        self.assertEqual(compress, '000000001000010000100001000010000100001000010000100001000010000100001000010000100001000010000100001000010000100001000010000100001000010000100001000010000100001000010')
        uncompress = hw6.uncompress(compress)
        self.assertEqual(uncompress, sequence)
        self.assertAlmostEqual(hw6.compression(sequence), 2.5781, 4)
        
    def test08(self):
        sequence = '11001001' * 8
        compress = hw6.compress(sequence)
        self.assertEqual(compress, '00000000100001000001000100001100010000010001000011000100000100010000110001000001000100001100010000010001000011000100000100010000110001000001000100001100010000010001000001')
        uncompress = hw6.uncompress(compress)
        self.assertEqual(uncompress, sequence)
        self.assertAlmostEqual(hw6.compression(sequence), 2.65625, 4)
